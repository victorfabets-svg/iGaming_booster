...
export function validateIdentifier(type: string, value: string): IdentifierValidationResult {
  const issues: string[] = [];
...
function validatePixE2E(value: string): IdentifierValidationResult {
  const issues: string[] = [];
  let confidence = 0.9;
...
function validateTransactionReference(value: string): IdentifierValidationResult {
  const issues: string[] = [];
  let confidence = 0.85;
...
function validateBoleto(value: string): IdentifierValidationResult {
  const issues: string[] = [];
  let confidence = 0.8;
...
function validatePaymentReference(value: string): IdentifierValidationResult {
  const issues: string[] = [];
  let confidence = 0.85;

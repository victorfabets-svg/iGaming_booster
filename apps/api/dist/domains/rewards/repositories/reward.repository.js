...
exports.findAllRewards = findAllRewards;
...
async function findAllRewards() {
    const result = await database_1.pool.query(`SELECT id, user_id, proof_id, type, status, created_at
     FROM rewards.rewards

...
exports.startProofSubmittedConsumer = startProofSubmittedConsumer;
const event_consumer_repository_1 = require("../../../../../../shared/events/event-consumer.repository");
const process_proof_submitted_use_case_1 = require("../use-cases/process-proof-submitted.use-case");
const EVENT_TYPE = 'proof_submitted';
const POLL_INTERVAL_MS = 5000;
const BATCH_SIZE = 10;
async function startProofSubmittedConsumer() {
...
async function pollEvents() {
    try {
        const allEvents = await (0, event_consumer_repository_1.fetchUnprocessedEvents)(BATCH_SIZE);
...
async function processEvent(event) {
    ...
    try {
        await (0, process_proof_submitted_use_case_1.processProofSubmitted)(payload);
...
//# sourceMappingURL=proof-submitted.consumer.js.map
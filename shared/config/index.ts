...
// NOTE: isAutomaticApprovalEnabled removed - thresholds always from config for deterministic behavior
export { featureFlags as ff, isRewardsEnabled, isValidationEnabled } from './feature-flags';